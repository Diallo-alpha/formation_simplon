...
<li class="colonne   colonne_CHEF">
    <i class="fa-solid fa-school" style="color: #000;"></i>  <a href="/dashbord_formation.html">formations</a>
</li>
<li class="colonne">
...
<h1>tous les elements du contenu de la formations  doit etre sur cette div </h1>
</div>
